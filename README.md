...
flowchart TD
    ...
    B --> C[(MySQL Database)]
    B --> D[Web Crawlers]
    D -->|Fetch Prices & Compare the best price| E[Online Stores]
    F[Redis Cache] --> B
...
## API Routes
 Can check out the API list generated by swagger-ui (access via http://localhost:8080/swagger-ui/index.html)
